...
// });
mongoose.connect( "mongodb+srv://samiullah:RYoDjxFbVBCMJl79@cluster0.945nh.mongodb.net/md?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => {
        app.listen(3000, () => {
